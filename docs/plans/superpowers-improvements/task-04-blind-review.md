# Task 4 — Nuova skill siae-blind-review

**Stato:** [PENDING]
**Dipendenze:** nessuna
**File coinvolti:**
- `skills/siae-blind-review/SKILL.md` (nuovo)
...
```bash
mkdir -p skills/siae-blind-review
```

## Step 2 — Scrivi SKILL.md

Crea `skills/siae-blind-review/SKILL.md` seguendo il template da
`skills/siae-writing-skills/reference/skill-template.md`.
...
```bash
test -f skills/siae-blind-review/SKILL.md && echo "OK" || echo "MISSING"
grep -c "BLIND REVIEW REPORT" skills/siae-blind-review/SKILL.md
```
Output atteso: `OK` e almeno 2 occorrenze.

## Step 4 — Commit

```bash
git add skills/siae-blind-review/SKILL.md
git commit -m "feat(skills): add siae-blind-review skill — spec-only audit (#865)"
```
