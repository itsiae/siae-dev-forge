# Task 06 — Phase 0-bis: Code Scan [PENDING]

**File:** `skills/siae-qa/SKILL.md` + NUOVO `skills/siae-qa/reference/code-scan.md`
**Sezione:** SKILL.md → inserire dopo Phase 0 e prima di Fase 1
...
Aggiungere una nuova fase opzionale "Phase 0-bis — Code Scan" che legge il codice sorgente
per derivare scenari di test non emergibili dagli AC. Stima +65-85% scenari aggiuntivi per BE e Auth.

---

## Step 1 — Crea il file reference/code-scan.md

Crea `skills/siae-qa/reference/code-scan.md` con il contenuto seguente:
...
## Step 2 — Inserisci Phase 0-bis in SKILL.md

Leggi `skills/siae-qa/SKILL.md`. Individua la riga `### Fase 1 — Lettura AC da Jira [HARD-GATE]`.
...
## Step 3 — Aggiungi Phase 0-bis alla checklist di verifica

Leggi `skills/siae-qa/XRAY-TEMPLATES.md` sezione "Checklist di Verifica".

Aggiungi dopo la riga `- [ ] Phase 0 eseguita`:
...
```bash
git add skills/siae-qa/SKILL.md skills/siae-qa/reference/code-scan.md skills/siae-qa/XRAY-TEMPLATES.md
git commit -m "feat(siae-qa): add Phase 0-bis Code Scan with extraction rules for BE/FE/ETL/Auth"
```
