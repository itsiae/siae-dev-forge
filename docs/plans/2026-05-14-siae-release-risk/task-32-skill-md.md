...
Implementare `skills/siae-release-risk/SKILL.md` come orchestratore markdown sottile (~280 righe) che invoca `lib/release_risk/cli.py`, gestisce AskUserQuestion per i 4-5 gap reali, mostra pre-flight card 🟡 MEDIO.

## File coinvolti

- Create: `skills/siae-release-risk/SKILL.md`

## Step

### Step 1 — Write SKILL.md

Write `skills/siae-release-risk/SKILL.md`:
```markdown
---
...
```bash
git add skills/siae-release-risk/SKILL.md
git commit -m "feat(release-risk): SKILL.md 10-step orchestrator + workflow + pre-flight card"
```

## Criteri di accettazione

- [ ] Frontmatter `name` + `description` con trigger keywords (release-risk, scorecard, CAB gate, ...)
- [ ] 10-step workflow + Step 4b genesis
- [ ] Pre-flight card 🟡 MEDIO obbligatoria Step 5
- [ ] Skip override documentato
- [ ] Reference link a checklist + criteri + design doc
- [ ] Commit eseguito
