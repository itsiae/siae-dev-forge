...
Creare template `skills/siae-release-risk/reference/release-criticality-checklist.md` (deriva dalla skill esterna, adattato a 18 criteri + max 36 + soglie SIAE).

## File coinvolti

- Create: `skills/siae-release-risk/reference/release-criticality-checklist.md`

## Step

### Step 1 — Write template

Write `skills/siae-release-risk/reference/release-criticality-checklist.md` (~150 righe):
```markdown
...
```bash
git add skills/siae-release-risk/reference/release-criticality-checklist.md
git commit -m "feat(release-risk): reference checklist template (18 criteri, max 36, 4 livelli)"
```

## Criteri di accettazione

- [ ] Template con 18 criteri (15 originali + 3 nuovi)
- [ ] Max score 36
- [ ] 4 livelli con soglie 0-4/5-9/10-14/15+
- [ ] Sezione Genesis nuova
- [ ] Sezione Suggested Follow-up
- [ ] Commit eseguito
