...
| # | Task | File | Stato |
|---|------|------|-------|
| 1 | Auto-generate id_tag da epoch in genera_dataset() (Python) | `task-01-python-id-tag-epoch.md` | [PENDING] |
| 2 | Propagare run_epoch in genera_profilo() e meta block (Python) | `task-02-python-run-epoch-meta.md` | [PENDING] |
| 3 | Aggiornare ragione sociale con suffisso epoch (Python) | `task-03-python-ragione-sociale-epoch.md` | [PENDING] |
| 4 | Aggiungere --id-tag al CLI main() (Python) | `task-04-python-cli-id-tag.md` | [PENDING] |
| 5 | Aggiungere epoch tag ai pid in generate_profiles.js | `task-05-js-pid-epoch.md` | [PENDING] |
| 6 | Aggiornare output_schema.md con generated_at_epoch | `task-06-schema-update.md` | [PENDING] |
| 7 | Test cross-run uniqueness Python | `task-07-test-python-uniqueness.md` | [PENDING] |
| 8 | Test cross-run uniqueness Node.js | `task-08-test-js-uniqueness.md` | [PENDING] |
